...
from lib.model_test_new import HardDetectionAndLocalization
...
def process_multiscale(image, model, scales=[.5, 1, 2]):
    ...
    for idx, scale in enumerate(scales):
        ...
        dense_features = model(current_image)
        ...
        combined = HardDetectionAndLocalization()
        detections, displacements = combined.detectAndLocalize(dense_features)
